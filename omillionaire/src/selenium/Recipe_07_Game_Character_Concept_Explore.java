...
@Test
public class Recipe_07_Game_Character_Concept_Explore {
	...
	public void TC_03_Check_Sketch_To_Image() throws InterruptedException, AWTException {
		...
		driver.findElement(By.xpath("//p[1][contains(text(),'Game Character Concept Explore')]")).click(); // Mở AI
																											// Image
																											// Generator
																											// LCM page
		...
		// driver.findElement(By.xpath("(//div[@class='space-y-6']//input[@type='file'])[1]")).sendKeys(System.getProperty("user.dir")
		// + "/src/test/resources/testdatafile/Image01.jpg"); //Upload origion face
