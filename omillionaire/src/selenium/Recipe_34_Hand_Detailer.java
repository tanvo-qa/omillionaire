...
@Test
public class Recipe_34_Hand_Detailer {
	...
	public void TC_03_Check_Hand_Detailer() throws InterruptedException, AWTException {

		driver.findElement(By.xpath("//p[1][contains(text(),'Hand Detailer')]")).click(); // Mở Hand Detailer recipe
																							// page

		Thread.sleep(5000);

		driver.findElement(By.xpath("//input[@type='file']"))
				.sendKeys(System.getProperty("user.dir") + "/src/test/resources/testdatafile/Hand.jpg"); // Upload image
