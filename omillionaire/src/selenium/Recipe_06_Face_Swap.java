...
@Test
public class Recipe_06_Face_Swap {
	...
	public void TC_03_Check_Face_Swap() throws InterruptedException, AWTException {
		...
		// p[@class='font-semibold text-sm' and contains(text(),'Upload your origin
		// image')]
	}
